...
const Index = () => {
  ...
  const projects = [
    {
      ...
      description: "Tối ưu hóa quy trình vận hành và nâng cao hiệu quả công việc",
      image: project1,
    ...
    },
    {
      ...
      description: "Nâng cao năng lực bán hàng và marketing cho đội ngũ giáo dục",
      image: project1,
  ...
  const phases = [
    {
      ...
      description: "Làm quen với môi trường, định hướng mục tiêu và xây dựng kế hoạch học tập",
      activities: ["Orientation", "Goal Setting", "Team Building"]
    },
    {
      weeks: "Tuần 3-4",
      title: "Học tập & Thực hành",
      description: "Tham gia các khóa đào tạo chuyên sâu và bắt đầu thực hành với dự án thực tế",
      activities: ["Training Sessions", "Hands-on Practice", "Project Assignment"]
    },
    {
      weeks: "Tuần 5-6",
      title: "Thực hiện dự án",
      description: "Triển khai dự án dưới sự hướng dẫn của mentor và nhận phản hồi thường xuyên",
      activities: ["Project Implementation", "Mentoring", "Progress Review"]
    },
    {
      weeks: "Tuần 7-8",
      title: "Hoàn thiện & Đánh giá",
      description: "Hoàn thiện dự án, thuyết trình kết quả và nhận đánh giá từ doanh nghiệp",
  ...
  const benefits = [
    {
      ...
      description: "Làm việc với dự án thật, thách thức thật trong môi trường doanh nghiệp"
    },
    {
      icon: <Users className="h-6 w-6" />,
      title: "Mentoring chuyên gia",
      description: "Được hướng dẫn trực tiếp bởi các chuyên gia hàng đầu trong ngành"
    },
    {
      icon: <TrendingUp className="h-6 w-6" />,
      title: "Phát triển kỹ năng",
      description: "Nâng cao kỹ năng mềm, kỹ năng chuyên môn và khả năng thích ứng"
    },
    {
      icon: <Building2 className="h-6 w-6" />,
      title: "Networking",
      description: "Kết nối với các doanh nghiệp đối tác và mở rộng mạng lưới chuyên nghiệp"
    },
    {
      icon: <Award className="h-6 w-6" />,
      title: "Chứng nhận",
      description: "Nhận chứng chỉ hoàn thành từ doanh nghiệp và trường đại học"
    },
    {
  ...
  const careerLevels = [
    {
      ...
      features: ["Học tập cơ bản", "Thực hành dưới hướng dẫn", "Xây dựng mindset"],
    ...
    },
    {
      ...
      features: ["Toàn quyền quyết định", "Phát triển team", "Strategic thinking"],
  ...
  const partners = [
    "VNPT Group", "F Deli Company", "Einstein School", "Tech Corp", 
    "Business Solutions", "Digital Innovation", "Smart Systems", "Growth Partners",
    "Excellence Training", "Future Leaders"
  ];
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white">
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-4xl mx-auto leading-relaxed opacity-90">
            Chương trình tạo cơ hội để sinh viên hòa mình vào môi trường doanh nghiệp thực tế, 
            trải nghiệm công việc thật, dự án thật và thử thách thật.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                Học Kỳ Doanh Nghiệp (HKDN) là chương trình đào tạo thực hành thực tế tại doanh nghiệp, 
                tạo cầu nối hiệu quả giữa sinh viên – nhà trường – doanh nghiệp.
              </p>
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                Chương trình mang đến cơ hội trải nghiệm môi trường làm việc chuyên nghiệp, 
                phát triển kỹ năng thực tế và xây dựng mạng lưới quan hệ vững chắc.
              </p>
      ...
      <section className="py-20 bg-secondary/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold mb-6">Ai phù hợp với chương trình?</h2>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-4xl font-bold mb-6">Phương pháp đào tạo hiện đại</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-12">
              <Card className="shadow-soft">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-muted-foreground">Định hướng, training và mentoring hàng tuần</p>
                </CardContent>
              </Card>
              ...
              <Card className="shadow-soft">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-muted-foreground">Làm việc trực tiếp với dự án thực tế</p>
                </CardContent>
              </Card>
              ...
              <Card className="shadow-soft">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-muted-foreground">Kết hợp online và offline tại doanh nghiệp đối tác</p>
                </CardContent>
              </Card>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-subtle">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold mb-6">Thành công qua từng dự án</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Khám phá những dự án thực tế mà sinh viên đã tham gia và hoàn thành xuất sắc
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {projects.map((project) => (
              <Card key={project.id} className="group shadow-soft hover:shadow-strong transition-smooth overflow-hidden">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Chương trình được chia thành 4 giai đoạn rõ ràng, từ định hướng đến hoàn thiện
            </p>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8">
              {phases.map((phase, index) => (
                <Card key={index} className="shadow-soft hover:shadow-medium transition-smooth relative">
                  <CardContent className="p-8">
                    <div className="flex items-center mb-4">
                      ...
                      <div>
                        <Badge variant="outline" className="mb-1">{phase.weeks}</Badge>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Lộ trình rõ ràng giúp sinh viên phát triển từ người mới bắt đầu đến nhân viên chuyên nghiệp
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {careerLevels.map((level, index) => (
              <Card key={index} className="shadow-soft hover:shadow-medium transition-smooth relative group">
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      <h4 className="font-semibold text-sm mb-2 text-muted-foreground uppercase tracking-wide">Mục tiêu</h4>
                      <p className="text-sm leading-relaxed">{level.objective}</p>
                    </div>
                    
                    <div>
                      <h4 className="font-semibold text-sm mb-2 text-muted-foreground uppercase tracking-wide">Đặc điểm</h4>
                    ...
                    <div>
                      <h4 className="font-semibold text-sm mb-2 text-muted-foreground uppercase tracking-wide">Kết quả</h4>
                      <p className="text-sm leading-relaxed font-medium">{level.result}</p>
                    </div>
                  </div>
                </CardContent>
      ...
      <section className="py-20 bg-gradient-subtle">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Chương trình được thực hiện với sự hợp tác của các doanh nghiệp và tổ chức hàng đầu
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto text-white">
            ...
            <p className="text-xl mb-8 opacity-90 leading-relaxed">
              ...
              Đăng ký ngay hôm nay để đảm bảo suất học!
            </p>
      ...
      <footer className="py-12 bg-foreground text-background">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h3 className="text-2xl font-bold mb-4">Học Kỳ Doanh Nghiệp 2025</h3>
